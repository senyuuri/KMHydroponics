...
public class QnTemplateComparision extends Activity{
	private QnService qnService;
	private Button btn_prev,btn_next,btn_solution;
	private TextView com_progress,com_question,station_name;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_solution = (Button) findViewById(R.id.com_solution);
		com_progress = (TextView) findViewById(R.id.com_progress);
		station_name = (TextView) findViewById(R.id.com_title);
		...
		radioButton6 = (RadioButton) findViewById(R.id.radiobtn6);
		radioButton7 = (RadioButton) findViewById(R.id.radiobtn7);
		radioButton8 = (RadioButton) findViewById(R.id.radiobtn8);
		...
		com_progress.setText(String.valueOf(current_position+1)+"/"+String.valueOf(qn_size));
		Log.d("ComparisionQn", "ReceivedPositionValue"+String.valueOf(current_position));
		DBHandler dbHandler = new DBHandler(getApplicationContext());
		/**Set comparision question
		 * reserved for future versions
		com_question.setText(dbHandler.getQuestion(question.getQID()));
		**/
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_scanner:
			Intent intent = new Intent(QnTemplateComparision.this, ScannerActivity.class);
			QnTemplateComparision.this.startActivity(intent);
			return true;
		case R.id.station1:
	...
	public void showSolution(View view){
		...
		Log.d("ComparisionQn","===>ansString" + ansString);
		
		//store result
		DBHandler dbHandler = new DBHandler(getApplicationContext());
		dbHandler.storeResultComparision(question.getQID(), ansString);
	...
	public void saveCurrentSession(){
		...
		//Show dialog
		Builder builder = new AlertDialog.Builder(QnTemplateComparision.this);
		...
		builder.setPositiveButton("Start New Lesson", new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();
				//clear answers
				Intent intent = new Intent(QnTemplateComparision.this, MainActivity.class);
