...
public class Instruction1 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_next = (Button) findViewById(R.id.ins1_next);
		btn_prev = (Button) findViewById(R.id.ins1_prev);
		title = (TextView) findViewById(R.id.ins1_title);
		text = (TextView) findViewById(R.id.ins1_text);
		progress = (TextView) findViewById(R.id.ins1_progress);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_scanner:
			Intent intent = new Intent(Instruction1.this, ScannerActivity.class);
			Instruction1.this.startActivity(intent);
			return true;
		case R.id.station1:
	...
	public void saveCurrentSession(){
		...
		//Show dialog
		Builder builder = new AlertDialog.Builder(Instruction1.this);
		...
		builder.setPositiveButton("Start New Lesson", new OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				dialog.dismiss();
				//clear answers
				Intent intent = new Intent(Instruction1.this, MainActivity.class);
