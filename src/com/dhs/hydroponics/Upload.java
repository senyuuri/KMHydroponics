...
public class Upload extends Activity{
	...
	private Integer img_progress,json_size,upload_progress,img_size;
	private Float bar_now,bar_total;
	private List<String> img_list,json_list;
	private Button btn_upload,btn_amend;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.qn_upload);
		btn_upload = (Button) findViewById(R.id.btn_upload);
		btn_amend = (Button) findViewById(R.id.btn_amend);
		text_state = (TextView) findViewById(R.id.fb_state);
		jsonString = dbHandler.recordToJson();
		//Upload status
		ans_finish = false;
		img_finish = false;
		upload_progress = 0;
		...
		//set this activity as finished -- cannot resume
		dbHandler.saveCurrentProgress(-1);
	...
	public void uploadAll(View view){
		try{
			...
			dbHandler.appendToUpList(jsonString);
			//Clear records 
				...
				try{
					...
					for(int i  = 0; i < jarry.length(); i++){
						...
						if(dbHandler.getQnType(qid)==1){
							...
							Log.d("IMG", "IMG_name:"+img_test2[img_test1.length-1]);
							Log.d("IMG", "-----");
	...
	private void disable_upload_btn(){
		...
		public void handleMessage (Message msg)
		{
			...
			case 0:
				...
				if(ans_finish && img_finish){
					...
					//Show dialog window
					Builder builder = new AlertDialog.Builder(Upload.this);
					...
					text_state.setText("All records have been uploaded:)");
			...
			case 3:
				...
				ans_finish = false;
				img_finish = false;
				Builder builder2 = new AlertDialog.Builder(Upload.this);
			...
			case 4:
				progressDialog.dismiss();
				Builder builder3 = new AlertDialog.Builder(Upload.this);
